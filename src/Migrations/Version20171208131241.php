 ...
 */
class Version20171208131241 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE charge (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, contract_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, deadline DATE NOT NULL, status VARCHAR(255) NOT NULL, attachment VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_556BA434A76ED395 (user_id), INDEX IDX_556BA4342576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA434A76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id)');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA4342576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id)');
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840DA76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id)');
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D55284914 FOREIGN KEY (charge_id) REFERENCES charge (id)');
        $this->addSql('ALTER TABLE conversation ADD CONSTRAINT FK_8A8E26E9A76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id)');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAA76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id)');
